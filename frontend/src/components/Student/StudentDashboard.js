  ...
  return (
    ...
    <div><Toaster position="top-right"/></div>
      <div className="bg-violet-100/50 h-screen">
        <div className="w-xl pl-18 py-12 mx-auto">
          ...
          <div>
            ...
            <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm ">
              <div className="relative">
                <span class="inline-flex absolute z-10 top-2 right-2 items-center bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full">
