...
const AdminDashboard = () => {
  return (
    <div className="bg-violet-100/50">
      <div className="w-md  py-12 h-full m-auto">
        <h2 className="text-2xl font-semibold text-violet-500"> Admin Dashboard </h2>
        ...
        <div>
          <div className="flex flex-row">
            <label
              for="small-input"
              class=" mb-2 w-xs text-xl font-medium text-gray-900 dark:text-white"
            >
              Course Name
            </label>
            <input
